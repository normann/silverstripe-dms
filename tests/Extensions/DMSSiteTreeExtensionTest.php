...
use SilverStripe\DMS\Extensions\DMSSiteTreeExtension;
...
class DMSSiteTreeExtensionTest extends SapphireTest
{
    ...
    {
        Config::inst()->update(SiteTree::class, 'documents_enabled', $configSetting);
    ...
    {
        Config::inst()->update(SiteTree::class, 'documents_enabled', true);
        $siteTree = $this->objFromFixture(SiteTree::class, 's2');
