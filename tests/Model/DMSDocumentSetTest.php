...
class DMSDocumentSetTest extends SapphireTest
{
    ...
    {
        DMSDocumentSet::add_extension(StubRelatedDocumentExtension::class);
    ...
    public function testGetDocumentDisplayFields()
    {
        ...
        Config::inst()->update(DMSDocument::class, 'display_fields', array('apple' => 'Apple', 'orange' => 'Orange'));
    ...
    {
        Config::inst()->update(DMS::class, 'shortcode_handler_key', 'unit-test');
